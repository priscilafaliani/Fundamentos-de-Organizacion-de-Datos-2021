...
procedure recorrer_archivo_personas(var personas : archivo_personas);
var
    persona : reg_persona;
begin
    reset(personas);
    ...
    begin 
        ...
        imprimir_registro_persona(persona);
    end;
...
begin
    ...
    writeln('lectura del archivo...');
    recorrer_archivo_personas(personas);
